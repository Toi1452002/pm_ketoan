...
class PdfSoTienGuiView extends StatelessWidget {
  final String tuNgay;
      ...
      build: (context) {
        return [
            ...
            children: [
              ...
              pw.Expanded(
                child: pw.Column(
                  ...
                  children: [
                    pw.Text('Mẫu số: S056-DNN', style: pw.TextStyle(font: fontBold)),
          ...
          pw.Center(
            child: pw.Column(
              children: [
                pdfWidget.title('SỔ TIỀN GỬI NGÂN HÀNG', fontBold),
                pw.SizedBox(height: 5),
                pdfWidget.label('Số tài khoản: $soTK', fonData),
                pw.SizedBox(height: 5),
          ...
          pw.Row(
            children: [
              pdfWidget.container('STT', width: 30, widthBorder: .5, height: 30, font: fontBold),
              pdfWidget.container(
                'Ngày tháng ghi sổ',
                width: 70,
                height: 30,
              ...
              pw.Column(
                children: [
                  ...
                  pw.Row(
                    children: [
                      pdfWidget.container('Gửi vào', width: 80, widthBorder: .5, height: 15, font: fontBold),
                      pdfWidget.container('Rút ra', width: 80, widthBorder: .5, height: 15, font: fontBold),
                      pdfWidget.container('Còn lại', width: 80, widthBorder: .5, height: 15, font: fontBold),
                    ],
                  ),
                ],
              ),
...
void excelSoTienGui(TrinaGridStateManager stateManager) async {
  final data =
  stateManager.rows.map((e) {
    return SoTienModel(
      ngay: e.cells[SoTienString.ngay]!.value,
  ...
  sheetObject.cell(CellIndex.indexByString("G1")).value = TextCellValue("GuiVao");
  sheetObject.cell(CellIndex.indexByString("H1")).value = TextCellValue("RutRa");
